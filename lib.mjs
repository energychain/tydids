...
const ABIS = {
    ...
    "GHGTOKEN":[
        ...
        },
        {
            "inputs": [
                {
                    "internalType": "contract GHGNFT",
                    "name": "_ghgCertificates",
                    "type": "address"
                }
            ],
            "name": "setGhgCertificates",
            "outputs": [],
            "stateMutability": "nonpayable",
            "type": "function"
        },
...
export default function(privateKey , provider) {
    ...
    wallet.tydids.contracts.GHGCERTIFICATES = new ethers.Contract('0xC61a197c5b5478091AaDe64382c3Bd3502C81554', wallet.tydids.deployment.ABIS.GHG721, wallet);
