...
exports.wallet = function(privateKey , provider) {
    ...
    wallet.tydids.ABIS = require("./ABIS");
    wallet.tydids.contracts = {};
    wallet.tydids.contracts.GHGTOKEN = new ethers.Contract('0xFBe3428A58DAF225D84Ccf2a7A87892d53CC1b88', wallet.tydids.ABIS.GHGTOKEN, wallet);
    wallet.tydids.contracts.GHGSAVINGS = new ethers.Contract('0x3DB8AdC77cc25791cE3860DFa3630c9116FA1A96', wallet.tydids.ABIS.GHG20, wallet);
    wallet.tydids.contracts.GHGEMISSIONS = new ethers.Contract('0x68c2046c5dA08B140A509afCbA6f4C715e807d28', wallet.tydids.ABIS.GHG20, wallet);
    wallet.tydids.contracts.GHGCERTIFICATES = new ethers.Contract('0xf0D4F76638b78cFB7d1CfFcFa2C8D9496f1B5DE4', wallet.tydids.ABIS.GHG721, wallet);
